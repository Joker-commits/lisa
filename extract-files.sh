...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib64/libdlbdsservice.so | vendor/lib64/libstagefright_soft_ac4dec.so | vendor/lib64/libstagefrightdolby.so | vendor/lib64/hw/displayfeature.default.so)
